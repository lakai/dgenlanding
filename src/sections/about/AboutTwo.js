                        ...
                        <AboutCol md={6}>
                            <Col md={12}>
                                <AnimationContainer animation="fadeIn" delay={1500}>
                                    <AboutContent>
                                        <Heading>
                                            Mint Your <Color>DGEN\</Color>FRENDS
                                        </Heading>
                                        <Separator />
                                        <Text>
                                            Mint Price = 0.3ETH
                        ...
                        <Row>
                            <Col md={3}>
                                <AnimationContainer animation="fadeIn" delay={1000}>
                                    <CounterComponent>
                                        <Counter value={5} duration={5} delay={1000} symbol="+" text="DAYS" />
                                    </CounterComponent>
                                </AnimationContainer>
                            </Col>
                            <Col md={3}>
                                <AnimationContainer animation="fadeIn" delay={1000}>
                                    <CounterComponent>
                                        <Counter value={100} duration={5} delay={1000} symbol="+" text="HOURS" />
                                    </CounterComponent>
                                </AnimationContainer>
                            </Col>
                            <Col md={3}>
                                <AnimationContainer animation="fadeIn" delay={1000}>
                                    <CounterComponent>
                                        <Counter value={5} duration={5} delay={1000} text="MINS" />
                                    </CounterComponent>
                                </AnimationContainer>
                            </Col>
                            <Col md={3}>
                                <AnimationContainer animation="fadeIn" delay={1000}>
                                    <CounterComponent>
                                        <Counter value={10} duration={5} delay={1000} symbol="+" text="SECONDS" />
                                    </CounterComponent>
                                </AnimationContainer>
                            </Col>
                        </Row>
